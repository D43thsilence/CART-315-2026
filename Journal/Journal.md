...
## Session Project Final Journal: 2003D Breaker development and the future ((16/04/2026))

In our last class, we held a class wide playtesting sessions where students got to playtest other students' games and give feedback/recommendations based on their experience. In this week's journal I want to record the most valuable feedback I recieved, my response to said feedback, interesting findings and discoveries that occured during playtests, my reflections on all of the work done so far and think about what would be the future of this project beyond this class.

### Playtesting and Feedback

The 2003D Breaker playtesting sessions went through without the playtesters facing game breaking bugs or glitches. I was quite happy to notice this as it proves to me that all of the measures I implemented to prevent players from facing game breaking problems or getting stuck in the 1st level work as intended. Players easily grasped the game's controls and mechanics. Quickly developing strategies for controling the boomerang's trajectory in a way thet prevents them from getting hit while being able to strike enemies down.

During the playtests, many interesting discoveries and strategies were made. Some of these were unintended behaviour but others were interesting enough to me that I would definetly expand upon them in the future.

One player discovered that they could trap the boomerang under the first platform you spawn on. Making the entire level a breeze to complete. And since the enemies are bound to their spawn area, he could ignore them while blitzing his way to the end of the level. However, to complete the level, he had to hit the ball at the end of the level with the boomerang. Since it was stuck at the start of the level, he couldn't complete the level as it was impossible for him to get it unstuck from this far away. This "strategy" made me think of a new form of puzzle, a puzzle where you must send the boomerang into a room you cannot step in and guide it across that room using its movement trajectory to hit a target for example.

Another player realized that if they position the boomerang directly under them, jump and then land on it, the boomerang can carry them upwards like an elevator with the only cost being one life point since it will continue moving upwards to try to hit you (even if it already hit you). I was very suprised by this discovery, but I also thought it could lead to interesting avenues for more advanced players. Players who are more confident in their skills could use tricks like this to create shortcuts across levels to finish them faster at the cost of their life points. Or maybe in more difficult levels I could make techniques like these mandatory for overcoming certain obstacles.

After each playtest, players gave me feedback on various parts of the game.

Some players had complaints about the camera. Stating that its perspective makes it difficult to plan your jumps and estimate where you will land. Some even recommended to enable the player to look straight down, which would solve the problems mentionned beforehand. Before going into this playtest, I personally believed that my game wasn't too difficult. However I was suprised to see that many players struggled with the platforming and felt that the camera's position and available angles weren't helpful enough for platforming. To me, 2003D Breaker should be a challenging game, I wouldn't want to enable the players to look directly down as I want them to learn to move and manage the boomerang's position using the game's available tools instead of using universal tricks that work across platformers such as looking directly down.

Players also mentionned that dealing with the enemies was quite difficult sometimes due to how they would create a wall while approaching the player. This probably happens because each enemy has the exact same speed value. Which means they all move at the same speed. I could easily fix this by making enemies spawn with a random speed value, but I think that I will keep this type of behaviour for a specific type of enemy. Not all enemy types should advance in a wall-like formation towards the player. But It would be interesting if some did. Since it would add variety in enemy movement and behavior.

WHen I demoed the game's prototype myself, other playtesters watched me play my prototype and noticed some of the techniques that I was using to control the boomerang. They recommended me to include tutorials for such techniques in the game. But I believe that such techniques should come naturally to the players quite easily and quickly (for reference, I've only played my prototype for around 2 hours). So I personally do not see the need to include tutorials for such things. It would be more interesting if players themselves would have to create their own tricks and techniques to manage the boomerang position and share them with others if they are interested. Consequently, my game's base mechanics and their explanation must be open ended to enable exploration and emergent gameplay.

Many playtesters also made positive comments on the game's visuals. Even if the playtesting demo was mostly made using placeholder assets, they liked the visual aesthetic created by the assets combined with the post-processing. I now know that I am on the right track towards creating an interesting visual presentation for my game.

### Takeaways, Concluding thoughts and the future

This project was the first time I ever approached game development with the mindset of prototyping. My game development workflow already put heavy focus on incremental improvements and step-by-step development. But through the development of the prototype for 2003D Breaker I got to experience a complete game prototype development loop. Now I truly understand the process of creating and iterating a specific aspect of a game and I can apply this knowledge anywhere now. Whether it is when creating a specific mechanic, when designing a game's visuals, when planning a game's narrative, and much more. I learned alot from my successes and mistakes in this class and I am very proud of what I was able to make so far. I will definitely try to continue working on 2003D Breaker while maintaining this work structure and maybe even turn it into a complete game someday if possible!